...
case class OPMVV(
  ...
  vWen: Boolean,
  mWen: Boolean,
  uopSplitType: BitPat = UopSplitType.dummy,
  src1: BitPat = SrcType.vp,
  src2: BitPat = SrcType.vp
) extends XSDecodeBase {
  private def src3: BitPat = if (vdRen) SrcType.vp else SrcType.X
  def generate() : List[BitPat] = {
    XSDecode(src1, src2, src3, fu, fuOp, SelImm.X, uopSplitType, xWen, F, vWen, mWen, F, F, F, F).generate()
  }
}
...
object VecDecoder extends DecodeConstants {
  ...
  val opivi: Array[(BitPat, XSDecodeBase)] = Array(
    ...
    VMSLEU_VI     -> OPIVI(FuType.vialuF, VialuFixType.vmsleu_vv, F, T, F, selImm = SelImm.IMM_OPIVIS, uopSplitType = UopSplitType.VEC_VXM),
    VMSLE_VI      -> OPIVI(FuType.vialuF, VialuFixType.vmsle_vv, F, T, F, uopSplitType = UopSplitType.VEC_VXM),
    VMSGTU_VI     -> OPIVI(FuType.vialuF, VialuFixType.vmsgtu_vv, F, T, F, selImm = SelImm.IMM_OPIVIS, uopSplitType = UopSplitType.VEC_VXM),
    ...
    VSADDU_VI     -> OPIVI(FuType.vialuF, VialuFixType.vsaddu_vv, T, F, T, selImm = SelImm.IMM_OPIVIS),
  ...
  val opmvv: Array[(BitPat, XSDecodeBase)] = Array(
    ...
    VZEXT_VF2    -> OPMVV(T, FuType.vialuF, VialuFixType.vzext_vf2, F, T, F, UopSplitType.VEC_EXT2, src1 = SrcType.no), // vzext.vf2 vd, vs2, vm
    VZEXT_VF4    -> OPMVV(T, FuType.vialuF, VialuFixType.vzext_vf4, F, T, F, UopSplitType.VEC_EXT4, src1 = SrcType.no), // vzext.vf4 vd, vs2, vm
    VZEXT_VF8    -> OPMVV(T, FuType.vialuF, VialuFixType.vzext_vf8, F, T, F, UopSplitType.VEC_EXT8, src1 = SrcType.no), // vzext.vf8 vd, vs2, vm
  ...
  val opfff: Array[(BitPat, XSDecodeBase)] = Array(
    // Scalar Float Point
    FADD_S -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfadd, F, T, T, UopSplitType.SCA_SIM),
    FADD_D -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfadd, F, T, T, UopSplitType.SCA_SIM),
    FSUB_S -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfsub, F, T, T, UopSplitType.SCA_SIM),
    FSUB_D -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfsub, F, T, T, UopSplitType.SCA_SIM),
    FEQ_S  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfeq , T, F, F, UopSplitType.SCA_SIM),
    FLT_S  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vflt , T, F, F, UopSplitType.SCA_SIM),
    FLE_S  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfle , T, F, F, UopSplitType.SCA_SIM),
    FEQ_D  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfeq , T, F, F, UopSplitType.SCA_SIM),
    FLT_D  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vflt , T, F, F, UopSplitType.SCA_SIM),
    FLE_D  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfle , T, F, F, UopSplitType.SCA_SIM),
    FMIN_S -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfmin, F, T, T, UopSplitType.SCA_SIM),
    FMIN_D -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfmin, F, T, T, UopSplitType.SCA_SIM),
    FMAX_S -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfmax, F, T, T, UopSplitType.SCA_SIM),
    FMAX_D -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfmax, F, T, T, UopSplitType.SCA_SIM),
    // Scalar Float Point Convert Inst.
    FCVT_W_S  -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.vfcvt_xfv,   T, F, F, UopSplitType.SCA_SIM),
    FCVT_WU_S -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.vfcvt_xufv,  T, F, F, UopSplitType.SCA_SIM),
    FCVT_L_S  -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.vfwcvt_xfv,  T, F, F, UopSplitType.SCA_SIM),
    FCVT_LU_S -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.vfwcvt_xufv, T, F, F, UopSplitType.SCA_SIM),
    FCVT_W_D  -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.vfncvt_xfw,  T, F, F, UopSplitType.SCA_SIM),
    FCVT_WU_D -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.vfncvt_xufw, T, F, F, UopSplitType.SCA_SIM),
    FCVT_L_D  -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.vfcvt_xfv,   T, F, F, UopSplitType.SCA_SIM),
    FCVT_LU_D -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.vfcvt_xufv,  T, F, F, UopSplitType.SCA_SIM),
    FCVT_S_D  -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.vfncvt_ffw,  F, T, T, UopSplitType.SCA_SIM),
    FCVT_D_S  -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.vfwcvt_ffv,  F, T, T, UopSplitType.SCA_SIM),
    //Scala Half-Precision Float Convert Inst.
    // FCVT_H_S  -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.fcvt_h_s,  F, T, T, UopSplitType.SCA_SIM),
    // FCVT_S_H  -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.fcvt_s_h,  F, T, T, UopSplitType.SCA_SIM),
    // FCVT_H_D  -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.fcvt_h_d,  F, T, T, UopSplitType.SCA_SIM),
    // FCVT_D_H  -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, VfcvtType.fcvt_d_h,  F, T, T, UopSplitType.SCA_SIM),
    // Scalar Float Point f2i MV Inst.
    FMV_X_D -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, FuOpType.FMVXF, T, F, F, UopSplitType.SCA_SIM),
    FMV_X_W -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, FuOpType.FMVXF, T, F, F, UopSplitType.SCA_SIM),
    // FMV_X_H -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfcvt, FuOpType.FMVXF, T, F, F, UopSplitType.SCA_SIM),
    // donot wflags
    FCLASS_S -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfalu, VfaluType.vfclass, T, F, F, UopSplitType.SCA_SIM),
    FCLASS_D -> OPFFF(SrcType.fp, SrcType.X, SrcType.X, FuType.vfalu, VfaluType.vfclass, T, F, F, UopSplitType.SCA_SIM),
    FSGNJ_S  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfsgnj , F, T, T, UopSplitType.SCA_SIM),
    FSGNJ_D  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfsgnj , F, T, T, UopSplitType.SCA_SIM),
    FSGNJX_S -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfsgnjx, F, T, T, UopSplitType.SCA_SIM),
    FSGNJX_D -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfsgnjx, F, T, T, UopSplitType.SCA_SIM),
    FSGNJN_S -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfsgnjn, F, T, T, UopSplitType.SCA_SIM),
    FSGNJN_D -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfalu, VfaluType.vfsgnjn, F, T, T, UopSplitType.SCA_SIM),

    FMUL_S -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfma , VfmaType.vfmul, F, T, T, UopSplitType.SCA_SIM),
    FMUL_D -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfma , VfmaType.vfmul, F, T, T, UopSplitType.SCA_SIM),

    FDIV_S  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfdiv, VfdivType.vfdiv , F, T, T, UopSplitType.SCA_SIM),
    FDIV_D  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfdiv, VfdivType.vfdiv , F, T, T, UopSplitType.SCA_SIM),
    FSQRT_S -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfdiv, VfdivType.vfsqrt, F, T, T, UopSplitType.SCA_SIM),
    FSQRT_D -> OPFFF(SrcType.fp, SrcType.fp, SrcType.X, FuType.vfdiv, VfdivType.vfsqrt, F, T, T, UopSplitType.SCA_SIM),

    FMADD_S  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.fp, FuType.vfma, VfmaType.vfmacc , F, T, T, UopSplitType.SCA_SIM),
    FMSUB_S  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.fp, FuType.vfma, VfmaType.vfmsac , F, T, T, UopSplitType.SCA_SIM),
    FNMADD_S -> OPFFF(SrcType.fp, SrcType.fp, SrcType.fp, FuType.vfma, VfmaType.vfnmacc, F, T, T, UopSplitType.SCA_SIM),
    FNMSUB_S -> OPFFF(SrcType.fp, SrcType.fp, SrcType.fp, FuType.vfma, VfmaType.vfnmsac, F, T, T, UopSplitType.SCA_SIM),
    FMADD_D  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.fp, FuType.vfma, VfmaType.vfmacc , F, T, T, UopSplitType.SCA_SIM),
    FMSUB_D  -> OPFFF(SrcType.fp, SrcType.fp, SrcType.fp, FuType.vfma, VfmaType.vfmsac , F, T, T, UopSplitType.SCA_SIM),
    FNMADD_D -> OPFFF(SrcType.fp, SrcType.fp, SrcType.fp, FuType.vfma, VfmaType.vfnmacc, F, T, T, UopSplitType.SCA_SIM),
    FNMSUB_D -> OPFFF(SrcType.fp, SrcType.fp, SrcType.fp, FuType.vfma, VfmaType.vfnmsac, F, T, T, UopSplitType.SCA_SIM),
  )
  ...
  val opfvv: Array[(BitPat, XSDecodeBase)] = Array(
    ...
    VFSQRT_V           -> OPFVV(SrcType.X , SrcType.vp , FuType.vfdiv, VfdivType.vfsqrt, F, T, F, UopSplitType.VEC_VVV), // vfsqrt.v vd, vs2, vm

    // 13.9. Vector Floating-Point Reciprocal Square-Root Estimate Instruction
    VFRSQRT7_V         -> OPFVV(SrcType.X , SrcType.vp , FuType.vfcvt, VfcvtType.vfrsqrt7, F, T, F, UopSplitType.VEC_VVV), // vfrsqrt7.v vd, vs2, vm
  ...
  val opfvf: Array[(BitPat, XSDecodeBase)] = Array(
    ...
    VFMV_F_S           -> OPFVF(SrcType.X, SrcType.X, FuType.vfalu, VfaluType.vfmv_f_s, T, T, F, UopSplitType.dummy), // f[rd] = vs2[0] (rs1=0)
  ...
  val vls: Array[(BitPat, XSDecodeBase)] = Array(
    ...
    VLE8_V        -> VLD(SrcType.X,   VlduType.vle),
    VLE16_V       -> VLD(SrcType.X,   VlduType.vle),
    VLE32_V       -> VLD(SrcType.X,   VlduType.vle),
    VLE64_V       -> VLD(SrcType.X,   VlduType.vle),
    VSE8_V        -> VST(SrcType.X,   VstuType.vse),
    VSE16_V       -> VST(SrcType.X,   VstuType.vse),
    VSE32_V       -> VST(SrcType.X,   VstuType.vse),
    VSE64_V       -> VST(SrcType.X,   VstuType.vse),
    VLM_V         -> VLD(SrcType.X,   VlduType.vlm, mask = T),
    VSM_V         -> VST(SrcType.X,   VstuType.vsm, mask = T),
    // 7.5. Vector Strided Instructions
    VLSE8_V       -> VLD(SrcType.xp,  VlduType.vlse, uopSplitType = UopSplitType.VEC_S_LDST, strided = T),
    VLSE16_V      -> VLD(SrcType.xp,  VlduType.vlse, uopSplitType = UopSplitType.VEC_S_LDST, strided = T),
    VLSE32_V      -> VLD(SrcType.xp,  VlduType.vlse, uopSplitType = UopSplitType.VEC_S_LDST, strided = T),
    VLSE64_V      -> VLD(SrcType.xp,  VlduType.vlse, uopSplitType = UopSplitType.VEC_S_LDST, strided = T),
    VSSE8_V       -> VST(SrcType.xp,  VstuType.vsse, uopSplitType = UopSplitType.VEC_S_LDST, strided = T),
    VSSE16_V      -> VST(SrcType.xp,  VstuType.vsse, uopSplitType = UopSplitType.VEC_S_LDST, strided = T),
    VSSE32_V      -> VST(SrcType.xp,  VstuType.vsse, uopSplitType = UopSplitType.VEC_S_LDST, strided = T),
    VSSE64_V      -> VST(SrcType.xp,  VstuType.vsse, uopSplitType = UopSplitType.VEC_S_LDST, strided = T),
    // 7.6. Vector Indexed Instructions
    VLUXEI8_V     -> VLD(SrcType.vp,  VlduType.vluxe, uopSplitType = UopSplitType.VEC_I_LDST, indexed = T, ordered = F),
    VLUXEI16_V    -> VLD(SrcType.vp,  VlduType.vluxe, uopSplitType = UopSplitType.VEC_I_LDST, indexed = T, ordered = F),
    VLUXEI32_V    -> VLD(SrcType.vp,  VlduType.vluxe, uopSplitType = UopSplitType.VEC_I_LDST, indexed = T, ordered = F),
    VLUXEI64_V    -> VLD(SrcType.vp,  VlduType.vluxe, uopSplitType = UopSplitType.VEC_I_LDST, indexed = T, ordered = F),
    VLOXEI8_V     -> VLD(SrcType.vp,  VlduType.vloxe, uopSplitType = UopSplitType.VEC_I_LDST, indexed = T, ordered = T),
    ...
    VSOXEI8_V     -> VST(SrcType.vp,  VstuType.vsoxe, uopSplitType = UopSplitType.VEC_I_LDST, indexed = T, ordered = T),
    VSOXEI16_V    -> VST(SrcType.vp,  VstuType.vsoxe, uopSplitType = UopSplitType.VEC_I_LDST, indexed = T, ordered = T),
    ...
    VL1RE8_V      -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL1RE16_V     -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL1RE32_V     -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL1RE64_V     -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL2RE8_V      -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL2RE16_V     -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL2RE32_V     -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL2RE64_V     -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL4RE8_V      -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL4RE16_V     -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL4RE32_V     -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL4RE64_V     -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL8RE8_V      -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL8RE16_V     -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL8RE32_V     -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VL8RE64_V     -> VLD(SrcType.X,   VlduType.vlr, whole = T),
    VS1R_V        -> VST(SrcType.X,   VstuType.vsr, whole = T),
    VS2R_V        -> VST(SrcType.X,   VstuType.vsr, whole = T),
    VS4R_V        -> VST(SrcType.X,   VstuType.vsr, whole = T),
    VS8R_V        -> VST(SrcType.X,   VstuType.vsr, whole = T),
  )

  override val decodeArray: Array[(BitPat, XSDecodeBase)] = opfff
  //vset ++ opivv ++ opivx ++ opivi ++ opmvv ++ opmvx ++ opfvv ++ opfvf ++ opfff ++ vls
}
