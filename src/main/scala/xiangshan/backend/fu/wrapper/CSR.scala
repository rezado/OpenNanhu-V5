  ...
  with HasCircularQueuePtrHelper
{
  ...
  csrOut.customCtrl match {
    case custom =>
      ...
      custom.replay_escape_enable             := csrMod.io.status.custom.replay_escape_enable
      custom.replay_escape_threshold          := csrMod.io.status.custom.replay_escape_threshold
      // Rename
