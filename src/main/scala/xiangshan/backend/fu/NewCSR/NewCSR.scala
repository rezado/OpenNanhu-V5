  ...
  with IpIeAliasConnect
{
  ...
  io.status.custom.replay_escape_enable             := smblockctl.regOut.ENABLE_REPLAY_ESCAPE.asBool
  io.status.custom.replay_escape_threshold          := smblockctl.regOut.REPLAY_ESCAPE_TIME.asUInt
